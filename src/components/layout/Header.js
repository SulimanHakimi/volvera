...
export default function Header() {
    ...
    return (
        <>
            <header className="fixed top-0 left-0 right-0 z-50 bg-[#0f1724]/95 backdrop-blur-2xl border-b border-[rgba(255,255,255,0.03)]">
                                        ...
                                        >
                                            {languages.map((lang) => (
                                                <button
                                                    ...
                                                    className={`w-full px-4 py-3 text-start text-sm hover:bg-[rgba(255,255,255,0.03)] transition-colors flex items-center gap-3 ${currentLanguage === lang.code ? 'bg-[#06b6d4]/10 text-[#06b6d4]' : 'text-[#9aa4b2]'
                                                        }`}
                                                >
